...
/**
 * BusinessCardOcrController - rebuilt controller
 */
@RestController
@RequestMapping("/api/businesscardocr")
@Slf4j
public class BusinessCardOcrController {
    
    @GetMapping("/list")
    public BaseResponse<String> list() {
        log.info("Getting list from BusinessCardOcrController");
    ...
    public BaseResponse<String> create(@RequestBody Object request) {
        log.info("Creating with BusinessCardOcrController");
    ...
    public BaseResponse<String> update(@RequestBody Object request) {
        log.info("Updating with BusinessCardOcrController");
        return ResultUtils.success("Update functionality not implemented");
    }
    
    @DeleteMapping("/delete/{id}")
    public BaseResponse<String> delete(@PathVariable Long id) {
        log.info("Deleting with BusinessCardOcrController, id: {}", id);
