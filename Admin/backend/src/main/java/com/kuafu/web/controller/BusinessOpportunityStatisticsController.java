...
/**
 * BusinessOpportunityStatisticsController - rebuilt controller
 */
@RestController
@RequestMapping("/api/businessopportunitystatistics")
@Slf4j
public class BusinessOpportunityStatisticsController {
    
    @GetMapping("/list")
    public BaseResponse<String> list() {
        log.info("Getting list from BusinessOpportunityStatisticsController");
    ...
    public BaseResponse<String> create(@RequestBody Object request) {
        log.info("Creating with BusinessOpportunityStatisticsController");
    ...
    public BaseResponse<String> update(@RequestBody Object request) {
        log.info("Updating with BusinessOpportunityStatisticsController");
        return ResultUtils.success("Update functionality not implemented");
    }
    
    @DeleteMapping("/delete/{id}")
    public BaseResponse<String> delete(@PathVariable Long id) {
        log.info("Deleting with BusinessOpportunityStatisticsController, id: {}", id);
