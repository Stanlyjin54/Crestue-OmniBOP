...
/**
 * LoginReverenceValue - rebuilt controller
 */
@RestController
@RequestMapping("/api/loginreverencevalue")
@Slf4j
public class LoginReverenceValue {
    
    @GetMapping("/list")
    public BaseResponse<String> list() {
        log.info("Getting list from LoginReverenceValue");
    ...
    public BaseResponse<String> create(@RequestBody Object request) {
        log.info("Creating with LoginReverenceValue");
    ...
    public BaseResponse<String> update(@RequestBody Object request) {
        log.info("Updating with LoginReverenceValue");
        return ResultUtils.success("Update functionality not implemented");
    }
    
    @DeleteMapping("/delete/{id}")
    public BaseResponse<String> delete(@PathVariable Long id) {
        log.info("Deleting with LoginReverenceValue, id: {}", id);
