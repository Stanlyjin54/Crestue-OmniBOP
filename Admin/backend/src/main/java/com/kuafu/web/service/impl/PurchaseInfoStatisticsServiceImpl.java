...
/**
 * PurchaseInfoStatisticsServiceImpl - rebuilt service implementation
 */
@Service
public class PurchaseInfoStatisticsServiceImpl {
    
    private static final Logger log = LoggerFactory.getLogger(PurchaseInfoStatisticsServiceImpl.class);
