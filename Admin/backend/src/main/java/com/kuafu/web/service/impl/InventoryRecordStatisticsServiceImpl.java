...
/**
 * InventoryRecordStatisticsServiceImpl - rebuilt service implementation
 */
@Service
public class InventoryRecordStatisticsServiceImpl {
    
    private static final Logger log = LoggerFactory.getLogger(InventoryRecordStatisticsServiceImpl.class);
