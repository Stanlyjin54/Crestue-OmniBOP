...
/**
 * LoginMangerController - rebuilt controller
 */
@RestController
@RequestMapping("/api/loginmanger")
public class LoginMangerController {
    
    private static final Logger log = LoggerFactory.getLogger(LoginMangerController.class);
    
    @GetMapping("/list")
    public BaseResponse<String> list() {
        log.info("Getting list from LoginMangerController");
    ...
    public BaseResponse<String> create(@RequestBody Object request) {
        log.info("Creating with LoginMangerController");
    ...
    public BaseResponse<String> update(@RequestBody Object request) {
        log.info("Updating with LoginMangerController");
        return ResultUtils.success("Update functionality not implemented");
    }
    
    @DeleteMapping("/delete/{id}")
    public BaseResponse<String> delete(@PathVariable Long id) {
        log.info("Deleting with LoginMangerController, id: {}", id);
