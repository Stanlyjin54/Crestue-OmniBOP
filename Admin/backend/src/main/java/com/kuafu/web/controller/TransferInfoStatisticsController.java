...
/**
 * TransferInfoStatisticsController - rebuilt controller
 */
@RestController
@RequestMapping("/api/transferinfostatistics")
public class TransferInfoStatisticsController {
    
    private static final Logger log = LoggerFactory.getLogger(TransferInfoStatisticsController.class);
    
    @GetMapping("/list")
    public BaseResponse<String> list() {
        log.info("Getting list from TransferInfoStatisticsController");
    ...
    public BaseResponse<String> create(@RequestBody Object request) {
        log.info("Creating with TransferInfoStatisticsController");
    ...
    public BaseResponse<String> update(@RequestBody Object request) {
        log.info("Updating with TransferInfoStatisticsController");
        return ResultUtils.success("Update functionality not implemented");
    }
    
    @DeleteMapping("/delete/{id}")
    public BaseResponse<String> delete(@PathVariable Long id) {
        log.info("Deleting with TransferInfoStatisticsController, id: {}", id);
