...
/**
 * CustomerInfoStatisticsController - rebuilt controller
 */
@RestController
@RequestMapping("/api/customerinfostatistics")
public class CustomerInfoStatisticsController {
    
    private static final Logger log = LoggerFactory.getLogger(CustomerInfoStatisticsController.class);
    
    @GetMapping("/list")
    public BaseResponse<String> list() {
        log.info("Getting list from CustomerInfoStatisticsController");
    ...
    public BaseResponse<String> create(@RequestBody Object request) {
        log.info("Creating with CustomerInfoStatisticsController");
    ...
    public BaseResponse<String> update(@RequestBody Object request) {
        log.info("Updating with CustomerInfoStatisticsController");
        return ResultUtils.success("Update functionality not implemented");
    }
    
    @DeleteMapping("/delete/{id}")
    public BaseResponse<String> delete(@PathVariable Long id) {
        log.info("Deleting with CustomerInfoStatisticsController, id: {}", id);
