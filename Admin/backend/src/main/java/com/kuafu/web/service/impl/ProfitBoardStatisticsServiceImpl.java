...
/**
 * ProfitBoardStatisticsServiceImpl - rebuilt service implementation
 */
@Service
public class ProfitBoardStatisticsServiceImpl {
    
    private static final Logger log = LoggerFactory.getLogger(ProfitBoardStatisticsServiceImpl.class);
