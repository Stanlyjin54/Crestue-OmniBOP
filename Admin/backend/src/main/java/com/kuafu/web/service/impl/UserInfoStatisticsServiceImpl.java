...
/**
 * UserInfoStatisticsServiceImpl - rebuilt service implementation
 */
@Service
public class UserInfoStatisticsServiceImpl {
    
    private static final Logger log = LoggerFactory.getLogger(UserInfoStatisticsServiceImpl.class);
