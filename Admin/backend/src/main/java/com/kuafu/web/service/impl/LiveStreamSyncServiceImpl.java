...
/**
 * LiveStreamSyncServiceImpl - rebuilt service implementation
 */
@Service
public class LiveStreamSyncServiceImpl {
    
    private static final Logger log = LoggerFactory.getLogger(LiveStreamSyncServiceImpl.class);
