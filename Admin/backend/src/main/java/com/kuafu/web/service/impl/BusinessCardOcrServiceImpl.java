...
/**
 * BusinessCardOcrServiceImpl - rebuilt service implementation
 */
@Service
public class BusinessCardOcrServiceImpl {
    
    private static final Logger log = LoggerFactory.getLogger(BusinessCardOcrServiceImpl.class);
