...
/**
 * InventoryRecordStatisticsController - rebuilt controller
 */
@RestController
@RequestMapping("/api/inventoryrecordstatistics")
@Slf4j
public class InventoryRecordStatisticsController {
    
    @GetMapping("/list")
    public BaseResponse<String> list() {
        log.info("Getting list from InventoryRecordStatisticsController");
    ...
    public BaseResponse<String> create(@RequestBody Object request) {
        log.info("Creating with InventoryRecordStatisticsController");
    ...
    public BaseResponse<String> update(@RequestBody Object request) {
        log.info("Updating with InventoryRecordStatisticsController");
        return ResultUtils.success("Update functionality not implemented");
    }
    
    @DeleteMapping("/delete/{id}")
    public BaseResponse<String> delete(@PathVariable Long id) {
        log.info("Deleting with InventoryRecordStatisticsController, id: {}", id);
