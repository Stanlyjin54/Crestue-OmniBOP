...
/**
 * AiAssistantLogStatisticsServiceImpl - rebuilt service implementation
 */
@Service
public class AiAssistantLogStatisticsServiceImpl {
    
    private static final Logger log = LoggerFactory.getLogger(AiAssistantLogStatisticsServiceImpl.class);
