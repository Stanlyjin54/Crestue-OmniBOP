...
/**
 * UserInfoStatisticsController - rebuilt controller
 */
@RestController
@RequestMapping("/api/userinfostatistics")
@Slf4j
public class UserInfoStatisticsController {
    
    @GetMapping("/list")
    public BaseResponse<String> list() {
        log.info("Getting list from UserInfoStatisticsController");
    ...
    public BaseResponse<String> create(@RequestBody Object request) {
        log.info("Creating with UserInfoStatisticsController");
    ...
    public BaseResponse<String> update(@RequestBody Object request) {
        log.info("Updating with UserInfoStatisticsController");
        return ResultUtils.success("Update functionality not implemented");
    }
    
    @DeleteMapping("/delete/{id}")
    public BaseResponse<String> delete(@PathVariable Long id) {
        log.info("Deleting with UserInfoStatisticsController, id: {}", id);
