...
/**
 * PurchaseInfoServiceImpl - rebuilt service implementation
 */
@Service
public class PurchaseInfoServiceImpl {
    
    private static final Logger log = LoggerFactory.getLogger(PurchaseInfoServiceImpl.class);
