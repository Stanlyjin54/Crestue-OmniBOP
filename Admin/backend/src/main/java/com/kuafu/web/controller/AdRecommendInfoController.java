...
/**
 * AdRecommendInfoController - rebuilt controller
 */
@RestController
@RequestMapping("/api/adrecommendinfo")
@Slf4j
public class AdRecommendInfoController {
    
    @GetMapping("/list")
    public BaseResponse<String> list() {
        log.info("Getting list from AdRecommendInfoController");
    ...
    public BaseResponse<String> create(@RequestBody Object request) {
        log.info("Creating with AdRecommendInfoController");
    ...
    public BaseResponse<String> update(@RequestBody Object request) {
        log.info("Updating with AdRecommendInfoController");
        return ResultUtils.success("Update functionality not implemented");
    }
    
    @DeleteMapping("/delete/{id}")
    public BaseResponse<String> delete(@PathVariable Long id) {
        log.info("Deleting with AdRecommendInfoController, id: {}", id);
