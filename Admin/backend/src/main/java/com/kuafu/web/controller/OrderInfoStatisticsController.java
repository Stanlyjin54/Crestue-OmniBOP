...
/**
 * OrderInfoStatisticsController - rebuilt controller
 */
@RestController
@RequestMapping("/api/orderinfostatistics")
@Slf4j
public class OrderInfoStatisticsController {
    
    @GetMapping("/list")
    public BaseResponse<String> list() {
        log.info("Getting list from OrderInfoStatisticsController");
    ...
    public BaseResponse<String> create(@RequestBody Object request) {
        log.info("Creating with OrderInfoStatisticsController");
    ...
    public BaseResponse<String> update(@RequestBody Object request) {
        log.info("Updating with OrderInfoStatisticsController");
        return ResultUtils.success("Update functionality not implemented");
    }
    
    @DeleteMapping("/delete/{id}")
    public BaseResponse<String> delete(@PathVariable Long id) {
        log.info("Deleting with OrderInfoStatisticsController, id: {}", id);
