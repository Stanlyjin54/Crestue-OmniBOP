...
<!--            </div>-->
            ...
            <div class="flex-start-center m-y-20 m-l-22">
                <el-divider v-if="app_vip" direction="vertical" style="border-color: #5D5FEF; border-width: 4px; border-radius: 2px; height: 20px;"/>
    ...
    <div class="flex-1 flex-column m-l-2" >
        ...
        <div class="overflow-y-scroll" :style="{height: appMainHeight+'px', width: appMainWidth+'px', background: '#fff'}">
          <router-view />
        </div>
