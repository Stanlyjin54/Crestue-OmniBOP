...
import com.kuafu.web.mapper.TransferInfoAllMapper;
 ...
 */
@Slf4j
@Service("TransferInfoAll")
public class TransferInfoAllServiceImpl extends ServiceImpl<TransferInfoAllMapper, TransferInfoAll> implements ITransferInfoAllService {
@Autowired
private TransferInfoAllMapper taskInfoAllMapper;


@Override
public List<TransferInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<TransferInfoAll> queryWrapper) {

        LambdaQueryWrapper<TransferInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<TransferInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<TransferInfoAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<TransferInfoAll> queryWrapper) {
        LambdaQueryWrapper<TransferInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<TransferInfoAll> page, PageRequest pageRequest, LambdaQueryWrapper<TransferInfoAll> queryWrapper) {
