...
import com.kuafu.web.mapper.UserRoleAllMapper;
...
@Slf4j
@Service("UserRoleAll")
public class UserRoleAllServiceImpl extends ServiceImpl<UserRoleAllMapper, UserRoleAll> implements IUserRoleAllService {
@Autowired
private UserRoleAllMapper taskInfoAllMapper;


@Override
public List<UserRoleAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<UserRoleAll> queryWrapper) {

        LambdaQueryWrapper<UserRoleAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<UserRoleAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<UserRoleAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<UserRoleAll> queryWrapper) {
        LambdaQueryWrapper<UserRoleAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<UserRoleAll> page, PageRequest pageRequest, LambdaQueryWrapper<UserRoleAll> queryWrapper) {
