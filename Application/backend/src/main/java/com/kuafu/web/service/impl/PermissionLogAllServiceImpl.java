...
import com.kuafu.web.mapper.PermissionLogAllMapper;
 ...
 */
@Slf4j
@Service("PermissionLogAll")
public class PermissionLogAllServiceImpl extends ServiceImpl<PermissionLogAllMapper, PermissionLogAll> implements IPermissionLogAllService {
@Autowired
private PermissionLogAllMapper taskInfoAllMapper;


@Override
public List<PermissionLogAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<PermissionLogAll> queryWrapper) {

        LambdaQueryWrapper<PermissionLogAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<PermissionLogAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<PermissionLogAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<PermissionLogAll> queryWrapper) {
        LambdaQueryWrapper<PermissionLogAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<PermissionLogAll> page, PageRequest pageRequest, LambdaQueryWrapper<PermissionLogAll> queryWrapper) {
