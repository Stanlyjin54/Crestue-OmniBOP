...
import com.kuafu.web.mapper.BusinessCardOcrAllMapper;
 ...
 */
@Slf4j
@Service("BusinessCardOcrAll")
public class BusinessCardOcrAllServiceImpl extends ServiceImpl<BusinessCardOcrAllMapper, BusinessCardOcrAll> implements IBusinessCardOcrAllService {
@Autowired
private BusinessCardOcrAllMapper taskInfoAllMapper;


@Override
public List<BusinessCardOcrAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<BusinessCardOcrAll> queryWrapper) {

        LambdaQueryWrapper<BusinessCardOcrAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<BusinessCardOcrAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<BusinessCardOcrAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<BusinessCardOcrAll> queryWrapper) {
        LambdaQueryWrapper<BusinessCardOcrAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<BusinessCardOcrAll> page, PageRequest pageRequest, LambdaQueryWrapper<BusinessCardOcrAll> queryWrapper) {
