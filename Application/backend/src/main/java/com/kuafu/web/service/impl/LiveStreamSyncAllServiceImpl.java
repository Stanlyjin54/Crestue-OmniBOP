 ...
 */
@Slf4j
@Service("LiveStreamSyncAll")
public class LiveStreamSyncAllServiceImpl extends ServiceImpl<LiveStreamSyncAllMapper, LiveStreamSyncAll> implements ILiveStreamSyncAllService {
@Autowired
private LiveStreamSyncAllMapper taskInfoAllMapper;


@Override
public List<LiveStreamSyncAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<LiveStreamSyncAll> queryWrapper) {

        LambdaQueryWrapper<LiveStreamSyncAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<LiveStreamSyncAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<LiveStreamSyncAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<LiveStreamSyncAll> queryWrapper) {
        LambdaQueryWrapper<LiveStreamSyncAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<LiveStreamSyncAll> page, PageRequest pageRequest, LambdaQueryWrapper<LiveStreamSyncAll> queryWrapper) {
