...
import com.kuafu.web.mapper.PurchaseInfoAllMapper;
 ...
 */
@Slf4j
@Service("PurchaseInfoAll")
public class PurchaseInfoAllServiceImpl extends ServiceImpl<PurchaseInfoAllMapper, PurchaseInfoAll> implements IPurchaseInfoAllService {
@Autowired
private PurchaseInfoAllMapper taskInfoAllMapper;


@Override
public List<PurchaseInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<PurchaseInfoAll> queryWrapper) {

        LambdaQueryWrapper<PurchaseInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<PurchaseInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<PurchaseInfoAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<PurchaseInfoAll> queryWrapper) {
        LambdaQueryWrapper<PurchaseInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<PurchaseInfoAll> page, PageRequest pageRequest, LambdaQueryWrapper<PurchaseInfoAll> queryWrapper) {
