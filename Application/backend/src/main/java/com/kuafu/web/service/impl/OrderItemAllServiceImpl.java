...
import com.kuafu.web.mapper.OrderItemAllMapper;
 ...
 */
@Slf4j
@Service("OrderItemAll")
public class OrderItemAllServiceImpl extends ServiceImpl<OrderItemAllMapper, OrderItemAll> implements IOrderItemAllService {
@Autowired
private OrderItemAllMapper taskInfoAllMapper;


@Override
public List<OrderItemAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<OrderItemAll> queryWrapper) {

        LambdaQueryWrapper<OrderItemAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<OrderItemAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<OrderItemAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<OrderItemAll> queryWrapper) {
        LambdaQueryWrapper<OrderItemAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<OrderItemAll> page, PageRequest pageRequest, LambdaQueryWrapper<OrderItemAll> queryWrapper) {
