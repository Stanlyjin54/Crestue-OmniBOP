...
import com.kuafu.web.mapper.InventoryRecordAllMapper;
 ...
 */
@Slf4j
@Service("InventoryRecordAll")
public class InventoryRecordAllServiceImpl extends ServiceImpl<InventoryRecordAllMapper, InventoryRecordAll> implements IInventoryRecordAllService {
@Autowired
private InventoryRecordAllMapper taskInfoAllMapper;


@Override
public List<InventoryRecordAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<InventoryRecordAll> queryWrapper) {

        LambdaQueryWrapper<InventoryRecordAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<InventoryRecordAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<InventoryRecordAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<InventoryRecordAll> queryWrapper) {
        LambdaQueryWrapper<InventoryRecordAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<InventoryRecordAll> page, PageRequest pageRequest, LambdaQueryWrapper<InventoryRecordAll> queryWrapper) {
