...
import com.kuafu.web.mapper.OrderInfoAllMapper;
...
@Autowired
private OrderInfoAllMapper taskInfoAllMapper;


@Override
public List<OrderInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<OrderInfoAll> queryWrapper) {

        LambdaQueryWrapper<OrderInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<OrderInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<OrderInfoAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<OrderInfoAll> queryWrapper) {
        LambdaQueryWrapper<OrderInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<OrderInfoAll> page, PageRequest pageRequest, LambdaQueryWrapper<OrderInfoAll> queryWrapper) {
