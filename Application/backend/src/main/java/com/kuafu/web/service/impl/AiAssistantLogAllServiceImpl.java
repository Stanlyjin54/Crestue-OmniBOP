...
import com.kuafu.web.mapper.AiAssistantLogAllMapper;
 ...
 */
@Slf4j
@Service("AiAssistantLogAll")
public class AiAssistantLogAllServiceImpl extends ServiceImpl<AiAssistantLogAllMapper, AiAssistantLogAll> implements IAiAssistantLogAllService {
@Autowired
private AiAssistantLogAllMapper taskInfoAllMapper;


@Override
public List<AiAssistantLogAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<AiAssistantLogAll> queryWrapper) {

        LambdaQueryWrapper<AiAssistantLogAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<AiAssistantLogAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<AiAssistantLogAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<AiAssistantLogAll> queryWrapper) {
        LambdaQueryWrapper<AiAssistantLogAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<AiAssistantLogAll> page, PageRequest pageRequest, LambdaQueryWrapper<AiAssistantLogAll> queryWrapper) {
