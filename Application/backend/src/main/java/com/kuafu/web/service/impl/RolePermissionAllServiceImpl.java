...
import com.kuafu.web.mapper.RolePermissionAllMapper;
 ...
 */
@Slf4j
@Service("RolePermissionAll")
public class RolePermissionAllServiceImpl extends ServiceImpl<RolePermissionAllMapper, RolePermissionAll> implements IRolePermissionAllService {
@Autowired
private RolePermissionAllMapper taskInfoAllMapper;


@Override
public List<RolePermissionAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<RolePermissionAll> queryWrapper) {

        LambdaQueryWrapper<RolePermissionAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<RolePermissionAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<RolePermissionAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<RolePermissionAll> queryWrapper) {
        LambdaQueryWrapper<RolePermissionAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<RolePermissionAll> page, PageRequest pageRequest, LambdaQueryWrapper<RolePermissionAll> queryWrapper) {
