...
import com.kuafu.web.mapper.CustomerInfoAllMapper;
 ...
 */
@Slf4j
@Service("CustomerInfoAll")
public class CustomerInfoAllServiceImpl extends ServiceImpl<CustomerInfoAllMapper, CustomerInfoAll> implements ICustomerInfoAllService {
@Autowired
private CustomerInfoAllMapper taskInfoAllMapper;


@Override
public List<CustomerInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<CustomerInfoAll> queryWrapper) {

        LambdaQueryWrapper<CustomerInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<CustomerInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<CustomerInfoAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<CustomerInfoAll> queryWrapper) {
        LambdaQueryWrapper<CustomerInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<CustomerInfoAll> page, PageRequest pageRequest, LambdaQueryWrapper<CustomerInfoAll> queryWrapper) {
