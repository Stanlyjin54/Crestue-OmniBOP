...
import com.kuafu.web.mapper.AdRecommendInfoAllMapper;
 ...
 */
@Slf4j
@Service("AdRecommendInfoAll")
public class AdRecommendInfoAllServiceImpl extends ServiceImpl<AdRecommendInfoAllMapper, AdRecommendInfoAll> implements IAdRecommendInfoAllService {
@Autowired
private AdRecommendInfoAllMapper taskInfoAllMapper;


@Override
public List<AdRecommendInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<AdRecommendInfoAll> queryWrapper) {

        LambdaQueryWrapper<AdRecommendInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<AdRecommendInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<AdRecommendInfoAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<AdRecommendInfoAll> queryWrapper) {
        LambdaQueryWrapper<AdRecommendInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<AdRecommendInfoAll> page, PageRequest pageRequest, LambdaQueryWrapper<AdRecommendInfoAll> queryWrapper) {
